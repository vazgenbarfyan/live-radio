                ...
                >
                    ...
                    <main className={s.content}>
                        <Switch>
                            ...
                            <Route path="/app/aboutus" exact component={TypographyBundle}/>
                            <Route path="/app/reviews" exact component={TablesBundle}/>
                            <Route path="/app/radiobooks" exact component={NotificationsBundle}/>
                            <Route path="/app/components/analytics" exact component={ChartsBundle}/>
                            <Route path="/app/components/location" exact component={MapsBundle}/>
